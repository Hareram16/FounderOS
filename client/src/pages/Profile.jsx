  ...
  const fetchProfile = async () => {
    try {
      ...
      const [profileRes, statsRes] = await Promise.all([
        fetch("https://founderos-5t6s.onrender.com/api/profile/me", {
          headers: { "x-auth-token": token },
        }),
        fetch("https://founderos-5t6s.onrender.com/api/profile/stats", {
          headers: { "x-auth-token": token },
        }),
      ]);
      ...
      if (profileRes.ok) {
        ...
        const errorData = await profileRes
          .json()
          .catch(() => ({ msg: "Failed to fetch profile" }));
      ...
      if (token) {
        try {
          const contribRes = await fetch(
            "https://founderos-5t6s.onrender.com/api/profile/contributions",
            {
              headers: { "x-auth-token": token },
            },
          );
      ...
      const mappedUser = {
        ...
        avatar:
          ...
          `https://api.dicebear.com/7.x/avataaars/svg?seed=${profileData.user?.username || "User"}`,
        coverImage:
        ...
        badges: [{ name: "Early Adopter", icon: "🚀", date: "2024" }],
  ...
  const saveProfile = async () => {
    try {
      ...
      const res = await fetch(
        "https://founderos-5t6s.onrender.com/api/profile",
        {
          method: "POST",
          headers: {
        ...
        >
          <button
            ...
            style={{
              ...
              borderRadius: "999px",
              background:
                viewMode === "owner" ? "var(--primary)" : "transparent",
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "999px",
              background:
                viewMode === "recruiter" ? "var(--primary)" : "transparent",
                ...
                <button
                  onClick={() => {
                    ...
                    if (email) {
                      ...
                      alert(
                        "No contact information available. Add social links to your profile.",
                      );
                    }
                  }}
                  className="btn-primary"
            ...
            >
              ...
              {contributions.length > 0 && (
                <section>
                  ...
                  >
                    <History size={20} className="text-gradient" /> Contribution
                    History
                  </h2>
                  <div
                    style={{
              ...
              >
                <div>
                  ...
                  >
                    <button
                      onClick={() =>
                        document.getElementById("modal-cover-upload").click()
                      }
                      style={{
                        position: "absolute",
                        inset: 0,
