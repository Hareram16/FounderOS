  ...
  const handleValidate = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://founderos-5t6s.onrender.com/api/ai/validate",
        {
          method: "POST",
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "1000px", margin: "0 auto" }}>
      <div
        ...
        style={{ padding: "3rem", marginBottom: "2rem", textAlign: "center" }}
      >
        <div
          style={{
        ...
        >
          Validate your startup idea instantly with our advanced AI analysis
          engine. Get viability scores, strengths, and actionable improvement
          suggestions.
        </p>
      </div>
          ...
          >
            ...
            >
              {loading ? (
                ...
                <>
                  <Lightbulb size={20} /> Validate Idea
                </>
              )}
            </button>
          </form>
          ...
          {result && (
            <div className="animate-fade-in">
              ...
              >
                ...
                <div
                  style={{
                    ...
                    fontWeight: "bold",
                    color:
                      result.viabilityScore > 80
                        ? "#4ade80"
                        : result.viabilityScore > 60
                          ? "#facc15"
                          : "#f87171",
                  }}
                >
              ...
              <div style={{ marginBottom: "1.5rem" }}>
                ...
                <ul
                  style={{ paddingLeft: "1.5rem", color: "var(--text-muted)" }}
                >
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          <h2 style={{ fontSize: "2rem", marginBottom: "1rem" }}>
            Innovation Roadmap Generator
          </h2>
          <p style={{ color: "var(--text-muted)" }}>
            Get a step-by-step execution plan for your project.
          </p>
        </div>
...
const RoadmapGenerator = () => {
  ...
  const handleGenerate = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://founderos-5t6s.onrender.com/api/ai/roadmap",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="Use the same description as above..."
              style={{
                width: "100%",
                padding: "0.8rem",
                background: "var(--input-bg)",
