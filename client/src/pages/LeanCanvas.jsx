  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        "https://founderos-5t6s.onrender.com/api/ai/lean-canvas",
        {
          method: "POST",
          headers: {
      ...
      if (res.ok) {
        ...
        setConversation([
          ...newConversation,
          {
            role: "assistant",
            content:
              "I've analyzed your idea and updated your Lean Canvas! Check out the canvas on the right to see the details filled in. Feel free to ask me to refine any section or add more details!",
          },
        ]);
      } else {
        const errorData = await res
          .json()
          .catch(() => ({ msg: "Failed to generate canvas" }));
        setConversation([
          ...newConversation,
          {
            role: "assistant",
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "1400px", margin: "0 auto" }}>
      ...
      >
        ...
        >
          Chat with AI to build your business model canvas. Just describe your
