            ...
            <div className="glass-panel" style={{ padding: '3rem' }}>
                ...
                <section style={{ marginBottom: '2.5rem' }}>
                    ...
                    <div style={{ marginTop: '1rem', padding: '1rem', background: 'rgba(255,255,255,0.05)', borderRadius: '8px' }}>
                        <p style={{ color: 'var(--text-main)', fontWeight: 'bold' }}>Grievance Officer: Hareram</p>
                        <p style={{ color: 'var(--text-muted)' }}>FounderOS India Pvt Ltd</p>
                        <p style={{ color: 'var(--text-muted)' }}>Email: grievance@founderos.in</p>
                ...
                <div style={{ padding: '1.5rem', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '12px', marginTop: '3rem' }}>
                    ...
                    <p style={{ color: 'var(--text-muted)', lineHeight: '1.6' }}>
                        If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@founderos.in" style={{ color: 'var(--primary)' }}>privacy@founderos.in</a>.
                    </p>
                </div>
            </div>
        </div>
