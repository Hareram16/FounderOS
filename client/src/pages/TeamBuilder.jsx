...
const TeamBuilder = () => {
  ...
  const fetchMatches = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `https://founderos-5t6s.onrender.com/api/team/match?${queryParams.toString()}`,
        {
  ...
  const handleConnect = async (userId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(
        "https://founderos-5t6s.onrender.com/api/team/connect",
        {
          method: "POST",
          headers: {
  ...
  const handleChat = async (userId) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(
        `https://founderos-5t6s.onrender.com/api/team/user/${userId}`,
        {
          headers: { "x-auth-token": token },
        },
      );
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        ...
        >
          Find the perfect co-founders and teammates. Our algorithm matches you
