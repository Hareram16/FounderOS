...
const GrantTracker = () => {
  ...
  const fetchGrants = async () => {
    try {
      ...
      const res = await fetch(
        `https://founderos-5t6s.onrender.com/api/grants?${params}`,
      );
      if (res.ok) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        "https://founderos-5t6s.onrender.com/api/grants",
        {
          method: "POST",
          headers: {
  ...
  return (
    <div style={{ padding: "2rem", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      >
        ...
        >
          Discover funding opportunities, scholarships, hackathons, and VC
      ...
      {loading ? (
        ...
        >
          <p style={{ color: "var(--text-muted)" }}>
            No opportunities found. Be the first to add one!
          </p>
        </div>
      ) : (
        <div
        ...
        >
          {grants.map((grant) => (
            <div
              ...
              style={{
                padding: "2rem",
                borderTop: `4px solid ${getTypeColor(grant.type)}`,
              }}
            >
              <div
                style={{
