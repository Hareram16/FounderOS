  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = initialData
        ? `https://founderos-5t6s.onrender.com/api/projects/${initialData._id}`
        : "https://founderos-5t6s.onrender.com/api/projects";
      ...
      if (
        ...
        alert(
          `Project ${initialData ? "updated" : "created"} in Demo Mode (Offline).`,
        );
      } else {
        alert(err.message);
      }
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              💡 Tip: Add "Hiring" tag to show your project on the Open Roles
              Board
            </p>
          </div>
